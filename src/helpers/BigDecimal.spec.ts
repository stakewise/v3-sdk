...
describe('BigDecimal', () => {
  ...
  it('should initialize correctly from string', () => {
    const value = '123.45'
    const decimal = new BigDecimal(value).decimals(2)
  ...
  it('should initialize correctly from bigint', () => {
    ...
    const decimal = new BigDecimal(value).decimals(0)
