---
id: enterExitQueue
slug: /sdk/api/osToken/transactions/enterexitqueue
description: Use the StakeWise SDK osToken enterExitQueue method to redeem osToken through the OsTokenRedeemer exit queue.
---
...
// Send transaction
const hash = await sdk.osToken.enterExitQueue(params)
...
const { data, to } = await sdk.osToken.enterExitQueue.encode(params)
// Get an approximate gas per transaction
const gas = await sdk.osToken.enterExitQueue.estimateGas(params)
```
