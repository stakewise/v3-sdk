...
export interface NativeTokenVaultAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "osTokenPositions"
      | "burnOsToken"
  ...
  encodeFunctionData(
    functionFragment: "setValidatorsManager",
    values: [AddressLike]
  ): string;
...
export interface NativeTokenVaultAbi extends BaseContract {
  connect(runner?: ContractRunner | null): NativeTokenVaultAbi;
  waitForDeployment(): Promise<this>;

  interface: NativeTokenVaultAbiInterface;
  ...
  setValidatorsManager: TypedContractMethod<
    [_validatorsManager: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setValidatorsManager"
  ): TypedContractMethod<
    [_validatorsManager: AddressLike],
    [void],
    "nonpayable"
